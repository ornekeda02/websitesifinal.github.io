function Buton4(){
    ...
    let B='Jpgler/TSE-7.jpg';
    A.setAttribute('src',B)
}

function Buton3(){
    let A=document.getElementById('TSE-3');
    let B='Jpgler/TSE-9.jpg';
    A.setAttribute('src',B)
}
